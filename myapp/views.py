...
import random
from mynotesapp import settings
from django.contrib.auth import logout
#import requests--->for sending otp to mobile phone
...
'''Send OTP on Mobile
install requests package in terminal:pip install requests
<---Line of code for sending otp on mobile--->
